...
RSpec.describe SponsoredPostsController, type: :controller do
   ...
   let(:my_sponsored_post) { my_topic.sponsored_posts.create!(title: RandomData.random_sentence, body: RandomData.random_paragraph, price: Integer) }
   ...
   describe "GET edit" do
    ...
    describe "POST create" do
       ...
       expect{ post :create, params: { topic_id: my_topic.id, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: Integer } } }.to change(SponsoredPost,:count).by(1)
       end
 
      it "assigns the new sponsored_post to @sponsored_post" do
        post :create, params: { topic_id: my_topic.id, post: { title: RandomData.random_sentence, body: RandomData.random_paragraph, price: Integer } }
 ...
 # #24
   ...
   describe "PUT update" do
     it "updates sponsored_post with expected attributes" do
       ...
       put :update, params: { topic_id: my_topic.id, id: my_sponsored_post.id, post: {title: new_title, body: new_body, price: new_price } } 
